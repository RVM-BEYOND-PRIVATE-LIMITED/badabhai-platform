        ...
        <>
          <div className="cols">
                      ...
                      <li className="funnel__row" key={p.provider}>
                        ...
                        <span className="funnel__nums">
                          ...
                          <span className="funnel__events">
                            {formatCount(p.call_count)} calls ·{" "}
                            {formatCount(p.real_call_count)} real · since{" "}
            ...
            <div>
              ...
              <p className="panel__sub">
                The other half of the cost table&rsquo;s key — and what makes the
                &ldquo;unknown provider&rdquo; row readable.
              </p>
                  ...
                  {cost.by_task_type.map((t) => (
                    <li className="funnel__row" key={t.task_type}>
                      ...
                      <span className="funnel__nums">
                        ...
                        <span className="funnel__events">
                          {formatCount(t.call_count)} calls · {formatCount(t.real_call_count)}{" "}
                          real
                        </span>
                      </span>
                    </li>
          ...
          <div>
            ...
            {breaches.by_reason.length === 0 ? (
              <p className="empty">
                No spend cap tripped in profile extraction over the last{" "}
                {breaches.window_days} days. Other AI surfaces are not covered by this count.
              </p>
            ) : (
