...
/// moments (the payer's flagship beats: a ₹40 unlock reveal, invites minted).
/// See [AppMotion.stamp].
///
...
///
/// Ported from worker-app's `BbSuccessStamp` so the "this worked" motif is
/// identical across both apps (#1077).
