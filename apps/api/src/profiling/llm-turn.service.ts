...
/**
 * `question-tts-text.ts`/`reply-closure.json` carry NO Devanagari twin for this line as of
 * #1505 (checked against the current merged tree, not assumed) — the voice form falls back to
