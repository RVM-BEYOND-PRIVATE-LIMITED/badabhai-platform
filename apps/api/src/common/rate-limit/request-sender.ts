 ...
 * DISTINCT buckets, never more SMS to one number — `WORKER_OTP_MAX_SENDS_PER_HOUR`
 * (10/number/hour on the worker path; admin and payer read `OTP_MAX_SENDS_PER_HOUR`, still 5,
 * since #1421), `OTP_MAX_SENDS_PER_DAY` (30/number/day) and the platform-wide
