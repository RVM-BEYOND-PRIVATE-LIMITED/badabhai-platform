...
@Module({
  ...
  // membership rule this module's search uses (#1240: `reach_skill_ids` overlap, applied/skipped
  // excluded), so the chat and the Jobs tab can never disagree about which jobs match. The
