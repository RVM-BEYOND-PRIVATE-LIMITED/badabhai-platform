...
export interface AdminChatSessionListItem {
   ...
   * interview: the idle sweep, or (#1744) the confirm of a profile made from an early finish.
   */
   ...
   */
  answer_count: number;
  /** `status === 'abandoned'` — the system's close (sweep or early-finish confirm), as a flag. */
  abandoned: boolean;
}
