"""Router: POST /skills/canonicalize and POST /skills/retag-plan.
...
@router.post("/skills/canonicalize", response_model=SkillCanonicalization)
...
@router.post("/skills/retag-plan", response_model=RetagPlanOutput)
