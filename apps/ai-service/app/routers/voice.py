"""Router: POST /voice/transcribe — gated STT plus the gated translate leg.
...
from ..runtime import logger, stt_adapter, translate_adapter

router = APIRouter()


@router.post("/voice/transcribe", response_model=TranscriptionOutput)
