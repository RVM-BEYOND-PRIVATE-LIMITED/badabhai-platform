...
def test_the_launch_families_chips_ALL_resolve_and_the_rest_are_measured_as_TD118():
    """TD118, pinned as EXECUTABLE data rather than a snapshot in a register.
    ...
    * The other five are RECORDED at their measured counts. Fixing them needs tool/skill
    ...
    assert resolving == {
        ...
        # --- TD118: unserved families, gazetteers absent ---
        "welding": (26, 42),
        "plumbing": (26, 38),
        "carpentry": (26, 39),
        "design": (31, 39),
        "interior_design": (31, 39),
    }, "chip resolution moved — update TD118 in docs/registers/tech-debt-register.md"
