...
_ROLE: list[AnswerFixture] = [
    ...
    F(
        "role",
        "abhi kuch nahi kar raha, kaam dhundh raha hu",
        expected="reject",
        register="hinglish",
        note="states no role",
    ),
...
_SKILLS: list[AnswerFixture] = [
    ...
    F(
        "skills",
        "vernier aur micrometer use karta hu",
        register="hinglish",
...
_PREFERRED_LOCATIONS: list[AnswerFixture] = [
    ...
    F(
        "preferred_locations",
        "abhi Pune mein hu, Delhi bhi chalega",
        register="hinglish",
...
_CERTIFICATIONS: list[AnswerFixture] = [
    ...
    F("certifications", "nahi", expected="reject", register="hinglish", note="bare denial"),
    F(
        "certifications",
        "certificate nahi liya, kaam se seekha",
        expected="reject",
        register="hinglish",
        note="negation must not assert its opposite",
    ),
]
