...
[`docs/registers/risks-register.md`](../registers/risks-register.md) (37 rows, R1–R37, restored
...
than forked into a competing document. Batch 1 proposed R38–R41; Batch 2 adds R42–R46 below.

**Renumbered 2026-08-13**: this document originally proposed R37–R45. While both audit PRs were
open, PR #832 landed a real, unrelated `R37` on the authoritative register (`resume_profile`
scalar fields bypassing pseudonymize certification — issue #831), which this audit's own
numbering had not reserved. All of this document's proposed rows were shifted up by one (R37→R38
… R45→R46) to clear the collision before anyone appends them. No proposed row's content changed,
only its ID.
...
R43, R44, and R46 are process/coverage gaps worth near-term action. R38, R39, R45 are lower
urgency. R40, R41 are recorded for completeness and require no near-term action.
