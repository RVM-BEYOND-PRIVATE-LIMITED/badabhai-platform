...
| 2026-06-16 | **Phase-1 schema foundation — declared STABLE, additive-only going forward** (DRAFT, awaiting CEO sign-off). Creates the previously-undocumented "item-10" gate as a concrete checklist + CEO sign-off block. **Not a hard freeze** — Phase-2 additive tables (monetization/reach) continue; the commitment is a change policy (additive + versioned + ADR for any breaking change, the operational form of invariant 8) over the current **21 tables** (migrations through `0015`). Items 1–9 closed; item-10 = the CEO declaration. Reconciles the stale schema doc (10→21 tables) | ADR | [0014-phase-1-schema-foundation-stable.md](../decisions/0014-phase-1-schema-foundation-stable.md) |
...
- [0014 — Phase-1 schema foundation: declared stable, additive-only](../decisions/0014-phase-1-schema-foundation-stable.md) — *DRAFT (awaiting CEO sign-off)*
