...
| [trade-content-ratification-packet.md](./trade-content-ratification-packet.md) | The reviewable RVM packet — full per-trade resume + kit content (×9) + PASS/CHANGES checklist | RVM reviews/signs off trade content |
