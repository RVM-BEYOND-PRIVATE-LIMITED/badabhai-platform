...
| Q3 | Default **LLM provider/model** via LiteLLM for extraction & canonicalization? Cost/latency/quality trade-off? | Drives R6 cost projection and staging enablement | Open |
