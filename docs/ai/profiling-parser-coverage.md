# Deterministic profiling parser — coverage measurement (POST-#426)
...
> correctness) and PR #412 (`41d0cb7`, TAX-WELD-1). The first revision of this
...
- turns: **5**
- extraction_ready: **True**
- answered topics: `['role', 'machines', 'skills', 'experience', 'current_location', 'preferred_locations']`
- **unanswered essentials: `[]`**
- never asked at all: `['machines', 'skills', 'controllers', 'salary_current', 'salary_expected', 'availability', 'education']`
- collected: `{'role': 'VMC Operator', 'machines': ['VMC'], 'skills': ['machine operation'], 'experience': 4.0, 'current_location': 'Pune', 'preferred_locations': 'flexible'}`
