...
15 specialized engineering roles Claude can act as for BadaBhai. Each file is a
...
**Two agents can block a merge on their own:** security-engineer (privacy/security)
and code-reviewer (correctness/invariants). A Critical privacy finding is never
downgraded.
