// Job-domain (occupation) RAG classification: the closed status vocabulary shared
// with the DB CHECK constraint, and the match schema the extraction output embeds.
import { z } from "zod";
