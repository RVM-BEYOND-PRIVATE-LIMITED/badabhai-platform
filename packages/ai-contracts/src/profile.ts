// Worker profile contracts: the legacy draft profile (taxonomy ids, stored shape),
// the rich extraction draft it is derived from, and the profile-extraction and
// resume-generation request-response pairs that carry them.
import { z } from "zod";

import { AICallMetadataSchema, ConversationMessageSchema } from "./common";
