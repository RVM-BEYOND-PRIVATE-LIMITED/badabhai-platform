// Payer domain: payer accounts/orgs/members, the contact-unlock + reveal spine,
// the monetization/pricing entitlement tables, the payment/referral-bonus spine,
// and the payer-side AI job-posting chat + drafts.
...
import type { MessageDirection, MessageType } from "@badabhai/types";
import { jsonObject } from "./_internal/json-defaults";
import { generatedResumes } from "./chat";
