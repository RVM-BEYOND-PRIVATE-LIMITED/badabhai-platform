// Demand-side domain: job_postings (ADR-0012), the alpha `jobs` + `applications`
// swipe-to-apply pair (ADR-0009), and the PACE per-job widening state.
...
import type { VacancyBand, JobPostingStatus, JobPostingVerificationStatus } from "@badabhai/types";
import type { TradeKey, SkipReason, SourceSurface } from "@badabhai/taxonomy";
import { jsonArray } from "./_internal/json-defaults";
