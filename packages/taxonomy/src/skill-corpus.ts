...
export const SKILL_CORPUS: readonly SkillSeed[] = [
  ...
  // ---- Trade widening — plumbing (provisional) ----
  {
    skillId: "skill_pipe_fitting",
    labelEn: "Pipe fitting",
    labelHi: null,
    domainId: "fitting-assembly",
    source: "onet",
    status: "provisional",
    aliases: [en("pipe fitting", "onet"), en("piping", "onet")],
  },
  {
    skillId: "skill_drainage_systems",
    labelEn: "Drainage systems",
    labelHi: null,
    domainId: "fitting-assembly",
    source: "onet",
    status: "provisional",
    aliases: [en("drainage", "onet"), en("sewer", "onet"), en("plumbing drainage", "onet")],
  },
  {
    skillId: "skill_water_supply",
    labelEn: "Water supply systems",
    labelHi: null,
    domainId: "fitting-assembly",
    source: "onet",
    status: "provisional",
    aliases: [en("water supply", "onet"), en("plumbing supply", "onet")],
  },
  {
    skillId: "skill_plumber_occupation",
    labelEn: "Plumber",
    labelHi: null,
    domainId: "fitting-assembly",
    source: "nco",
    status: "provisional",
    aliases: [en("plumber", "nco"), en("plumbing work", "nco")],
  },

  // ---- Trade widening — carpentry (provisional) ----
  {
    skillId: "skill_woodworking",
    labelEn: "Woodworking / joinery",
    labelHi: null,
    domainId: "fitting-assembly",
    source: "onet",
    status: "provisional",
    aliases: [en("woodworking", "onet"), en("joinery", "onet"), en("wood work", "onet")],
  },
  {
    skillId: "skill_cabinet_making",
    labelEn: "Cabinet making",
    labelHi: null,
    domainId: "fitting-assembly",
    source: "onet",
    status: "provisional",
    aliases: [en("cabinet making", "onet"), en("cabinetry", "onet")],
  },
  {
    skillId: "skill_furniture_finishing",
    labelEn: "Furniture finishing / polishing",
    labelHi: null,
    domainId: "fitting-assembly",
    source: "esco",
    status: "provisional",
    aliases: [en("finishing", "esco"), en("polishing", "esco"), en("furniture finishing", "esco")],
  },
  {
    skillId: "skill_carpenter_occupation",
    labelEn: "Carpenter",
    labelHi: null,
    domainId: "fitting-assembly",
    source: "nco",
    status: "provisional",
    aliases: [en("carpenter", "nco"), en("carpentry work", "nco")],
  },

  // ---- Trade widening — design (provisional) ----
  {
    skillId: "skill_cad_2d_drafting",
    labelEn: "2D CAD drafting",
    labelHi: null,
    domainId: "cnc-programming",
    source: "esco",
    status: "provisional",
    aliases: [en("2D drafting", "esco"), en("CAD drafting", "esco")],
  },
  {
    skillId: "skill_3d_modeling",
    labelEn: "3D modeling",
    labelHi: null,
    domainId: "cnc-programming",
    source: "esco",
    status: "provisional",
    aliases: [en("3D modeling", "esco"), en("3D modelling", "esco")],
  },
  {
    skillId: "skill_rendering_visualization",
    labelEn: "Rendering / visualization",
    labelHi: null,
    domainId: "cnc-programming",
    source: "esco",
    status: "provisional",
    aliases: [en("rendering", "esco"), en("3D visualization", "esco")],
  },
  {
    skillId: "skill_designer_occupation",
    labelEn: "Designer",
    labelHi: null,
    domainId: "cnc-programming",
    source: "nco",
    status: "provisional",
    aliases: [en("designer", "nco"), en("design work", "nco")],
  },

  // ---- Trade widening — interior design (provisional) ----
  {
    skillId: "skill_space_planning",
    labelEn: "Space planning",
    labelHi: null,
    domainId: "cnc-programming",
    source: "esco",
    status: "provisional",
    aliases: [en("space planning", "esco"), en("layout planning", "esco")],
  },
  {
    skillId: "skill_material_selection",
    labelEn: "Material selection",
    labelHi: null,
    domainId: "cnc-programming",
    source: "esco",
    status: "provisional",
    aliases: [en("material selection", "esco"), en("material specification", "esco")],
  },
  {
    skillId: "skill_interior_designer_occupation",
    labelEn: "Interior Designer",
    labelHi: null,
    domainId: "cnc-programming",
    source: "nco",
    status: "provisional",
    aliases: [en("interior designer", "nco"), en("interior design work", "nco")],
  },
] as const;
