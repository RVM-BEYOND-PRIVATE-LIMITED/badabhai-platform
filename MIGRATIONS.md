...
**`0085_revoke_execute_undeclared_routines`** (journal has 86 entries, `idx` 0–85).
...
| | |
|---|---|
| journal entries | 86 (`0000`–`0085`) |
| recorded, matching a journal entry | **85** |
| unrecorded | **1** — `0085`, written for #1110 and deliberately **not applied**; it awaits an owner decision, see its row above |
