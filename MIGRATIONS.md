...
**`0110_worker_language`** (journal has 111 entries, `idx` 0–110). This line has gone stale
...
| `0109`        | Prakash   | **APPLIED locally 2026-09-17; PR in flight** — ADR-0042 D9 / Layer A (a): `workers.whatsapp_enc` (nullable, AES-256-GCM token behind a shape CHECK). One `ADD COLUMN` + one `ADD CONSTRAINT`; no backfill. **APPLY-BEFORE-DEPLOY** — a bare `workers` select names every model column — registered as `0109-worker-whatsapp-enc-column` in `schema-contract.ts`, rotation target added in `reencrypt-pii-backfill.ts`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `0110`        | Prakash   | **APPLIED 2026-09-17; PR in flight** — ADR-0042 D9 / Layer A (b): `worker_language` (one row per language; speaks/reads/writes ticks; worker order). New empty table only; RLS ENABLE + hand-appended FORCE + four REVOKEs; registered as `0110-worker-language-table` + `0110-worker-language-rls` in `schema-contract.ts`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
